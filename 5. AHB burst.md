...
6. T2-T3:  HTRANS=NONSEQ (first data packet is transferred), HADDR-0X5C (starting address of another burst P1), HWRITE=0 (read data), HBURST=INCR, HSIZE= word (4 bytes)  
7. T3-T4: data of P1: HREADY=0 (master is ready to read data), HWDATA= XX HRDATA=XX
8. T3-T4: address of P1: HTRANS= SEQ, HADDR=0X5C+4=0X60,  HWRITE=0 (read data), HBURST=INCR, HSIZE= word (4 bytes)
9. T4-T5: data 
10. T4-T5: address
11. T5-T6:
12. T5-T6:
